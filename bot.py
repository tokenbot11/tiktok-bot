...
INSTAGRAM_USERNAME = os.environ.get("usef3770")
INSTAGRAM_PASSWORD = os.environ.get("josepH139900@@")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if mode == "instagram" and "instagram.com" in url:
        ...
        try:
            ...
            await update.message.reply_text("❌ نیاز به ورود به اینستاگرام داره. لطفاً با پشتیبانی تماس بگیر.", reply_markup=get_main_menu())
        except Exception as e:
